...
command.execute = function(message,args,client)
  ...
  if res.code == 404 then return {success = false, msg = (member.id == message.author.id and "You're not verified with Swirlyz. Verify here: <https://verify.eryn.io" or "**"..member.tag.."** isn't verified with Swirlyz.")} end
